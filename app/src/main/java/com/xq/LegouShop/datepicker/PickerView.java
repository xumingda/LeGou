package com.xq.LegouShop.datepicker;
...
public class PickerView extends View {
    ...
    private void initPaint() {
        ...
        mLightColor = ContextCompat.getColor(mContext, R.color.text_black);
        mDarkColor = ContextCompat.getColor(mContext, R.color.text_color_gray);
    }
