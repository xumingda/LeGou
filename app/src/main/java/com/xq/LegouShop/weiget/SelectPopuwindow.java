...
public class SelectPopuwindow extends PopupWindow {
    ...
    public SelectPopuwindow(final Activity context, final String string, final List<String> list, AdapterView.OnItemClickListener itemsOnClick) {
        LayoutInflater inflater = (LayoutInflater) context
                .getSystemService(Context.LAYOUT_INFLATER_SERVICE);
        this.context =context;
        conentView = inflater.inflate(R.layout.popuwindow_select_shop, null);
        ...
        TextView pop_title=(TextView) conentView.findViewById(R.id.pop_title);
        pop_title.setText(string);
        adapter = new SelectShopAdapter(context,list);
